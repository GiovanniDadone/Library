...
import { deleteEntity, getEntity } from './libro.reducer';
...
export const LibroDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="libraryApp.libro.delete.question">Are you sure you want to delete Libro {libroEntity.id}?</ModalBody>
      <ModalFooter>
