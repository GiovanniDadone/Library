...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECENSIONE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RECENSIONE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RECENSIONE actions', async () => {
      const arg = { id: 27588 };
    ...
    it('dispatches UPDATE_RECENSIONE actions', async () => {
      const arg = { id: 27588 };
    ...
    it('dispatches PARTIAL_UPDATE_RECENSIONE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RECENSIONE actions', async () => {
      const arg = 42666;
