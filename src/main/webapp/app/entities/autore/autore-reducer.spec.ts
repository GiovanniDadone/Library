...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './autore.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUTORE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AUTORE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AUTORE actions', async () => {
      const arg = { id: 13546 };
    ...
    it('dispatches UPDATE_AUTORE actions', async () => {
      const arg = { id: 13546 };
    ...
    it('dispatches PARTIAL_UPDATE_AUTORE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AUTORE actions', async () => {
      const arg = 42666;
